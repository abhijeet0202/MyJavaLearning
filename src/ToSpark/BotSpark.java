...
public class BotSpark {
	void doVM2Spark() throws IOException {
		String htmlSubject = "Message On behalf Of <b>Abhijeet Banerjee</b>: \nReturns From Office late, Sleeping Now, Will Join ";
		...
		InputStream audioStream = new FileInputStream("C:\\Users\\abhibane\\Downloads\\MyPTO.gif");
		...
		audioHeader.set("Content-Type", "image/png");
