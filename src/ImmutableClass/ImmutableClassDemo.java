...
public final class ImmutableClassDemo {
	...
	public ImmutableClassDemo(int i, String name, HashMap<String,String> hashMapObj){
		System.out.println("Performing Deep  for Object initialization");
		this.id=i;
		this.name=name;
		HashMap<String,String> tempMap=new HashMap<String,String>();
		String key;
		Iterator<String> it = hashMapObj.keySet().iterator();
		while(it.hasNext()){
			key=it.next();
			tempMap.put(key, hashMapObj.get(key));
		}
